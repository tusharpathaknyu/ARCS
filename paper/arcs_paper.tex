...
rewards further boosting structural validity to 100\%. On 16 circuit
...
\toprule
& Values & Specs & Graph & Speed & Data \\
\midrule
AnalogGenie & \texttimes & \texttimes & \texttimes & $\sim$1\,s & Manual \\
LaMAGIC     & \texttimes & \texttimes & \checkmark & N/A & Synthetic \\
CircuitSynth & \checkmark & \texttimes & \texttimes & $\sim$10\,s & RL only \\
\textbf{ARCS} & \checkmark & \checkmark & \checkmark & 0.02\,s & Auto \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Some topologies (Wien bridge SL: 0\%) have very low success
    rates, likely due to insufficient training data and high circuit
    sensitivity.
...
only 4.8\% more parameters. ARCS generates complete, SPICE-simulatable
