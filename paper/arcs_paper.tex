...
\begin{enumerate}
    ...
    distribution mismatch, where easy topologies dominate gradient
    updates and hard topologies are abandoned. GRPO resolves this
...
single SPICE template---no manual curation needed. Extending to
