...
sources (4 candidates/source; 16 topologies). Hybrid picks the
...
\midrule
VCG-only    & 100\% & 100\% & 90.6\% & 5.30 \\
CCFM-only   & 100\% & 100\% & 90.6\% & 5.02 \\
\textbf{Hybrid (VCG+CCFM)} & \textbf{100\%} & \textbf{100\%} & \textbf{100\%} & \textbf{6.23} \\
\bottomrule
\end{tabular}
\end{table}
...
sim-validity gap while improving average reward by +0.93 over VCG-only
and +1.21 over CCFM-only.
