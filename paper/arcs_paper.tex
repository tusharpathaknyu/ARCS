...
\bottomrule
\multicolumn{7}{@{}l}{\footnotesize $^\dagger$With grammar-constrained decoding; 58.8\% sim-valid without.}
\end{tabular}
\end{table}
...
REINFORCE (5000)       & 6.50M & 97.5\% & 44.4\% & 3.77 \\
...
69\% sim-validity vs.\ 49\% for REINFORCE and 51\% for SL. Among
