...
% ==========================================================================
\begin{abstract}
I present ARCS, a system for \emph{amortized} analog circuit generation
...
Policy Optimization} (GRPO)~\cite{shao2024grpo} to multi-topology
circuit RL: I identify a critical failure mode of
REINFORCE (cross-topology reward distribution mismatch) and resolve it
with per-topology advantage normalization, improving simulation validity
by +9.6\,pp over REINFORCE in only 500 RL steps ($10\times$ fewer).
